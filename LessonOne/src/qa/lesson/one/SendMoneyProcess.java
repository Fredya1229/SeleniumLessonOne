...
public class SendMoneyProcess {
	...
	public static void main(String[] args) {
		...
		SendMoneyProcess myObj = new SendMoneyProcess();
		myObj.invokeBrowser();
...
//				cvv.sendKeys("123");
				...
				double randomInt = rg.nextInt(400);
				...
				// New Enter Amount Screen
				driver.findElement(By.id("ed_Amount")).sendKeys(Double.toString(randomInt));
				
				//Click Continue button Step 1
				driver.findElement(By.id("btnContinue")).click();
				
				//When Amount is grater than allowed start
				
//				List<WebElement> amt = driver.findElements(By.id("lblErrors"));
//				int amterror=amt.size();
//				
//				if(amterror>0)
//				{
//					randomInt = randomInt - 50;
//					driver.findElement(By.id("ed_Amount")).sendKeys(Double.toString(randomInt));
//					driver.findElement(By.id("btnContinue")).click();
//				}
//				
				//When Amount is grater than allowed end				
				
				//Entering CVV 
				System.out.println("CVV entering");
				
			//	driver.findElement(By.cssSelector("#CardTokenData_Cvv")).sendKeys("321");
				...
				// To verify Free Note enable start
				
				List<WebElement> links = driver.findElements(By.id("btnCancelPromo"));
				int noButtons=links.size();
				//System.out.println("No. of buttons in the web page "+ noButtons );
				
				// To verify Free Note enable end
				
				if(noButtons>0)
				{
					//Free Note enable
					driver.findElement(By.id("message")).sendKeys("This is a Free Note test from Selenium Automation Tool " + confirmationNumber);
					driver.findElement(By.name("cb_Agree")).click();
					driver.findElement(By.id("btnSend")).click();
				}
				else
				{
					System.out.println("NO FREE NOTE No. of buttons in the web page "+ noButtons );
				}
